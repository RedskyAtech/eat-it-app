...
export default class login extends Component {
    ...
    render() {
        const { back_container, logo_container, profile_container,
                        ...
                        <ImageBackground source={require('../../assets/login_background.png')}
                            ...
                            <View style={[headings, row]}>
                                <TouchableOpacity onPress={this.onLogin}>
                                    <Text style={this.state.isLogin ? text : [text, headings_color]}>Login</Text>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={this.onRegister}>
                                    <Text style={!this.state.isLogin ? text : [text, headings_color]}>Register</Text>
                                </TouchableOpacity>
                            </View>
