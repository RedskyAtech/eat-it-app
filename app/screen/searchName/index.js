                    ...
                    <View style={list_height}>
                        <ScrollView>
                            {this.state.products.map((value) => {
                                return (
                                    <View style={[row, column_between_spacing, top_container, inner_list_spacing]}>

                                        <View style={row}>
                                            <View style={list_image_continer}>
                                                <Image resizeMode='cover' source={value.image} style={list_image} ></Image>
                                            </View>
                                            ...
                                            <View style={[column, column_between_spacing]}>
                                                ...
                                                <View style={[row, between_spacing,]}>
                                                    <View style={[row, row_center_align]}>
                                                        <View style={value.isVeg ? [non_veg_icon, green_color] : [non_veg_icon, red_color]}></View>
                                                        <Text style={text_style}>Non-veg</Text>
                                                    </View>
                                                    <View style={[row, row_center_align]}>
                                                        <Image resizeMode='stretch' source={require('../../assets/clock.png')} style={clock} ></Image>
